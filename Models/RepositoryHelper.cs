namespace MVC5Demo.Models
{
	public static class RepositoryHelper
	{
		...
		public static C__EFMigrationsHistoryRepository GetC__EFMigrationsHistoryRepository()
		{
			var repository = new C__EFMigrationsHistoryRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static C__EFMigrationsHistoryRepository GetC__EFMigrationsHistoryRepository(IUnitOfWork unitOfWork)
		{
			var repository = new C__EFMigrationsHistoryRepository();
